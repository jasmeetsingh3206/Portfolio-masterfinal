...
export default function NewCard() {
    ...
    return (
        <div className="flex flex-col rounded-lg items-center bg-white border border-gray-200 shadow md:flex-col md:max-w-xl hover:bg-gray-900 text-black">
            ...
            <button type="button" onClick={handleClick} class="text-white  bg-blue-700 hover:bg-blue-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
